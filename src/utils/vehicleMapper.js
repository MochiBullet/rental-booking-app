...
export const mapVehicleForCreate = (vehicleData) => {
  ...
  return {
    ...
    vehicleFeatures: Array.isArray(vehicleData.features) ? vehicleData.features : (vehicleData.features ? vehicleData.features.split(',').map(f => f.trim()) : []),
    features: Array.isArray(vehicleData.features) ? vehicleData.features : (vehicleData.features ? vehicleData.features.split(',').map(f => f.trim()) : []),
    comment: vehicleData.comment || '',
    vehicleComment: vehicleData.comment || '',
